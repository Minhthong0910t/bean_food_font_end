...
const SliderHome = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://192.168.1.4:3000/api/slider/getAll');
...
const Discount = ()=>{
  ...
  useEffect(()=>{
    const fetchData = async () => {
      try {
        const response = await fetch('http://192.168.1.4:3000/api/discount/getAll');
        const jsonData = await response.json();
...
const Foodngonquanhday = ()=>{
    ...
    useEffect(()=>{
      const fetchData = async () => {
        try {
          const response = await fetch('http://192.168.1.4:3000/api/restaurant/getAll');
          const jsonData = await response.json();
...
const Goiymonan = ({ navigation })=>{
  ...
  useEffect(()=>{
    const fetchData = async () => {
      try {
        const response = await fetch('http://192.168.1.4:3000/api/product/suggest');
        const jsonData = await response.json();
